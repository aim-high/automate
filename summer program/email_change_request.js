/*
After someone edits the attached spreadsheet on "Request for Change" column (F column), admin(s) receive email with time, site, grade, requester, message, and url to sheets.
Will also append request details to 2018-2020 Attendance Log File.
*/
